# narutor : Private Tor Network Using Docker with Docker-compose
## Originated by antitree/private-tor-network
## Modified for Tor Source version & Exit relay node 
...
```
docker-compose up --scale relay=5 --scale exit=3
/* docker-compose scale relay=5 exit=3 */ (not used)
```
